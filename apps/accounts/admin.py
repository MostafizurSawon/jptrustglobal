...
#     list_display = ('user', 'full_name', 'job_title', 'city', 'country', 'status')
#     search_fields = ('user__phone_number', 'full_name', 'status')
...
@admin.register(AgentInfo)
class AgentInfoAdmin(admin.ModelAdmin):
    form = AgentInfoForm  # Use the custom form that restricts user selection
