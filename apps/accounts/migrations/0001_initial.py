# Generated by Django 5.2.1 on 2025-06-14 11:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('guest', 'Guest'), ('accountant', 'Accountant'), ('manager', 'Manager'), ('hr', 'HR'), ('agent', 'Agent'), ('admin', 'Admin')], default='guest', max_length=20)),
